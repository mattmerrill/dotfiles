...
# Display ASCII control characters using caret notation in standard text views TODO
# Try e.g. `cd /tmp; unidecode "\x{0000}" > cc.txt; open -e cc.txt`
# defaults write NSGlobalDomain NSTextShowsControlCharacters -bool true

# Disable automatic termination of inactive apps TODO
...
# Never go into computer sleep mode TODOd
...
# Set a custom wallpaper image. `DefaultDesktop.jpg` is already a symlink, and TODO
...
# Disable press-and-hold for keys in favor of key repeat TODO
...
# Enable HiDPI display modes (requires restart) TODO
...
# Don't show local hard drive on desktop
...
###############################################################################
# Dock, Dashboard, Menu bar and hot corners                                   #
###############################################################################
...
# Menu bar
# add percentage to battery indicator
